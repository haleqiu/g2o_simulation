...
void keyboardEventOccurredmove (const pcl::visualization::KeyboardEvent &event,
                            void* viewer_void)
{
  pcl::visualization::PCLVisualizer *viewer = static_cast<pcl::visualization::PCLVisualizer *> (viewer_void);
  if (event.getKeySym () == "a" && event.keyDown ())
  {
    std::cout << "a was pressed => removing all text" << std::endl;
    pcl::PointXYZ test_point;
    test_point.x = 0;
    test_point.y = 0;
    test_point.z = 0;
    viewer->addSphere (test_point, 0.2, 0.5, 0.5, 0.0, "sphere");
...
pcl::visualization::PCLVisualizer::Ptr interactionCustomizationVis ()
{
  ...
  viewer->registerKeyboardCallback (keyboardEventOccurredmove, (void*)viewer.get ());
